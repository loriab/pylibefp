...
def test_opts_psi():
    ...
    pans2 = asdf.set_opts({'elst_damp': 'OFF', 'swf_cutoff': 1.0, 'elst': True, 'ai_elst': True, 'enable_cutoff': 0}, label='psi')
    ...
    pans3 = asdf.set_opts({'swf_cutoff': 2, 'elst': False, 'ai_elst': True, 'disp_damp': 'TT'}, append='append', label='psi')
    ...
    pans4 = asdf.set_opts({'elst_damp': 'OFF', 'swf_cutoff': 0.0, 'elst': True, 'enable_cutoff': 0}, append='libefp', label='psi')
...
def test_opts_psi_dflt():
    ...
    pdans1 = asdf.set_opts({}, label='psi', append='psi')
    ...
    pdans2 = asdf.set_opts({'elst_damp': 'OFF', 'swf_cutoff': 1.0, 'elst': True, 'ai_elst': False, 'enable_cutoff': 0}, label='psi', append='append')
    ...
    pdans3 = asdf.set_opts({'elst_damp': 'OVERlap', 'swf_cutoff': 2.0, 'elst': False, 'enable_cutoff': 0}, append='psi', label='psi')
